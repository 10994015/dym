...
if(isset($_POST['MM_process']) && $_POST['MM_process']=='addmem'){
    try{
        $sql_str = "INSERT INTO member ( name,username,mail,pwd,chkcode,up,lineid)
                      VALUES (:mem_name,:username,:mem_mail,:mem_pwd,:mem_chkcode,:mem_usercode,:mem_line)";
        ...
        $stmt -> bindParam(':mem_line' ,$mem_line);
